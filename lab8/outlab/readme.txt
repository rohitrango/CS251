...
TASK F:-
---------------------------------------------------------------------------------------
Earlier we thought that we would have to write the sorting algorithm, but built-in sort command saved the day! The rest was just a matter of syntax. It was good, as some of the bash syntax and commands got revised.

---------------------------------------------------------------------------------------
TASK G:-
---------------------------------------------------------------------------------------
The given code was very very inefficient. So optimising it didn't took much time. We discovered gprof2dot and dot tools to view call graphs. They will be very useful in future.
